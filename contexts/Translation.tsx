...
const TranslationContext = createContext<ITranslationState | undefined>(
  undefined,
);
    ...
    switch (language) {
      case "ja":
        setT({
          ...
          externalLoginDesc:
            "外部ログインはResoniteアカウントと連携した後に使えます",
          loginViaDiscord: "Discordでログイン",
          loginViaResoniteLove: "resonite.loveでログイン",
          sentCode:
            "ログインリクエストを送信しました。ワンタイムパスワードを入力してください。",
          resendCode: "コードを再送信",
          login: "ログイン",
          loggedIn: "ログインしてます",
          logout: "ログアウト",
      ...
      case "en":
        setT({
          ...
          externalLoginDesc:
            "External login is available after linking with Resonite account",
      ...
      case "ko":
        setT({
          ...
          externalLoginDesc:
            "외부 로그인은 Resonite 계정과 연결한 후 사용할 수 있습니다",
